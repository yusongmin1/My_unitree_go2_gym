        ...
        for i, motion_file in enumerate(motion_files):
            ...
            with open(motion_file, "r") as f:
                ...
                self.trajectories.append(torch.tensor(
                    motion_data[:, AMPLoader.ROOT_ROT_END_IDX:AMPLoader.JOINT_VEL_END_IDX], dtype=torch.float32, device=device))
    ...
    def feed_forward_generator(self, num_mini_batch, mini_batch_size):
        ...
        for _ in range(num_mini_batch):
            if self.preload_transitions:
                ...
                s = torch.cat([
                    s,
                    self.preloaded_s[idxs, AMPLoader.LINEAR_VEL_START_IDX:AMPLoader.ANGULAR_VEL_END_IDX],
                ...
                # print("s.shape, s_next.shape", s.shape, s_next.shape)
            else:
                s, s_next = [], []
