...
Go2_Cts_Cfg_Yu = load_cfg(
    "legged_gym/envs/Go2_Cts/Go2_Cts_Config.py",
    "Go2_Cts_Cfg_Yu",
)
import math
import numpy as np
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        ...
        while True:  # 无限循环，直到手动关闭程序
            ...
            if count_lowlevel % cfg.sim_config.decimation == 0:
                ...
                # policy 输入 = 6 帧 obs 拼接（前 5 帧喂 student_encoder，最后 1 帧为当前 obs）
                for i in range(6):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model', type=str, default=f'{LEGGED_GYM_ROOT_DIR}/logs/go2_cts/exported/policies/policy_cts.pt',help='Run to load from.')
    parser.add_argument('--terrain', action='store_true', help='terrain or plane')
    args = parser.parse_args()

    class Sim2simCfg(Go2_Cts_Cfg_Yu):
        class sim_config:
