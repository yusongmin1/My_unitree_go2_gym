...
from legged_gym.utils import  get_args, export_policy_as_jit, task_registry, Logger,export_policy_as_cts
...
def play(args):
    ...
    print(env)
    obs, privileged_buf, obs_hist_buf, critic_obs_buf= env.get_observations()
    # load policy
    ...
    for i in range(10*int(env.max_episode_length)):
        ...
        obs, privileged_obs,obs_hist_buf, critic_obs, _, _,_ = env.step(actions.detach())
        # print(obs[0])
