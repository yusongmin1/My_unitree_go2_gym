...
class Go2_env(BaseTask):
    ...
    def compute_observations(self):
        ...
        """
        self.obs_buf = torch.cat((  self.base_lin_vel * self.obs_scales.lin_vel, #3 基座线速度
    ...
    def _reward_orientation(self):
        ...
        # print("!!!!!!_reward_orientation",torch.mean(torch.norm(self.projected_gravity[:, :2], dim=1)))
    ...
    def _reward_base_height(self):
        ...
        # print("!!!!!!_reward_base_height",torch.mean(torch.abs(base_height - self.cfg.rewards.base_height_target)/self.cfg.rewards.tracking_sigma))
